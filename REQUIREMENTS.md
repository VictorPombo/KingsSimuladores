...
## V2 (Fast Follows)
- [ ] Recuperação de carrinho abandonado (WhatsApp + E-mail)
- [ ] Upsell/Cross-sell inteligênte no checkout
- [ ] Cupons de desconto avançados
- [ ] Exportação de relatórios complexos
- [ ] Integração nativa com TikTok Shopping e Google Shopping

## Out of Scope (For Now)
- App mobile nativo (foco em PWA/Responsividade web)
- Estoque próprio de usados (apenas intermediação / marketplace)
