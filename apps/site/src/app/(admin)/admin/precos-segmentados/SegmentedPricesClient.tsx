  ...
  return (
    <div className="segmented-container">
      <style dangerouslySetInnerHTML={{__html: `
        ...
        .sidebar { background: #2c2e36; border-radius: 12px; border: 1px solid #3f424d; padding: 20px; }
        .main-content { 
          background: #2c2e36; border-radius: 12px; border: 1px solid #3f424d; 
                    ...
                    <div className="card-controls">
                      ...
                      <div className="control-block prod-rule">
                        ...
                        <select 
                          disabled={isPending}
                          value={currentRule}
                          onChange={(e) => handleProductRuleChange(p.id, e.target.value as 'normal' | 'base_discount' | 'fixed')}
