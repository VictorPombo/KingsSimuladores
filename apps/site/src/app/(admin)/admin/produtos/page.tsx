...
export default async function AdminProdutosPage() {
  ...
  let query = supabase
    .from('products')
    .select('id, title, slug, sku, price, price_compare, stock, status, weight_kg, ncm, dimensions_cm, images, created_at, brand_id, category_id, brands!brand_id(name), categories!category_id(name)')
  ...
  const mapped = (products || []).map((p: any) => ({
    ...
    stock: p.stock, status: p.status, weight_kg: p.weight_kg, ncm: p.ncm, dimensions_cm: p.dimensions_cm, images: p.images || [],
